...
const mediaCards = [
    {
        outlet: 'Clarin',
        title: 'Vecino del GBA deslumbra con replicas de madera de los grandes estadios argentinos',
    ...
    {
        outlet: 'Infobae',
        title: 'La Bombonera y el Monumental que creo un artista callejero que se reinvento',
        excerpt: 'La nota repasa su historia antes y despues de la pandemia, y como transformo el oficio artesanal en su trabajo principal.',
    ...
    {
        outlet: 'Zonales',
        title: 'Las increibles maquetas de un vecino de Hurlingham que son furor entre los futboleros',
        excerpt: 'Una historia local sobre su reinvencion durante la pandemia y el salto de las ferias al taller propio.',
    ...
    },
    {
        ...
        excerpt: 'Una cobertura centrada en la precision del trabajo, la escala de las piezas y la expansion del emprendimiento.',
    ...
    },
    {
        ...
        excerpt: 'Una version inspiracional de su historia, enfocada en el oficio, la reinvencion y la pasion por crear estadios en miniatura.',
        ...
        <div class="about-creator__shell">
            <div class="about-creator__intro">
                ...
                <p>
                    ...
                    lograr una pieza que represente identidad, memoria y pasion.
                </p>
            </div>
            ...
            <div class="about-creator__media">
                <div class="about-creator__media-heading">
                    ...
                    <p>Notas y entrevistas donde comparti el camino del taller.</p>
                </div>
